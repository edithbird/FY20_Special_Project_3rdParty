...
According to Aaron Deets, our CAPPEX representative, given the unpredictable nature of inquiries, considering the funnel by anticipated start year is a good way to evaluate whether we see a return on investment.  It is important to note that confirmation and enrollment numbers will surely increase for 2020, as will all stages for 2021 and 2022. 2020 Cappex enrollments are likely to exceed those of 2019.
...
* Since 2016, Hobsons has consistently sent ~ 1,200 inquiry names per contract period. Cappex provides more inquiry names. Overall, ~ 50% of the the names are new to the University of Southern Maine. 
...
* Year over year, tuition revenue justifies the contract cost. (This is calculated as )

...
* Since 2016, Hobsons has consistently sent ~ 1,200 inquiry names per contract period. Cappex provides more inquiry names. Overall, ~ 50% of the the names are new to the University of Southern Maine. Cappex and Hobson account for 3.5% and 2.5% respectively of first-year student inquiries over the past 2 fiscal years. 
